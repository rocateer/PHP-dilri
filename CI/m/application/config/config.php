...
$config['sess_cookie_name'] = 'ci_session_'.SITE_NAME.'_m';
...
$config['csrf_token_name'] = SITE_NAME.'_token_name';
$config['csrf_cookie_name'] = SITE_NAME.'_token_name';
...
|--------------------------------------------------------------------------
*/
$modules_find =  $_SERVER['PHP_SELF'];

if(strpos($modules_find,'_v_') !== false){
  
  $modules_find = explode('/', $modules_find);
  if (strpos($modules_find[2],'_v_') !== false) {
    $modules_name = explode('_v_', $modules_find[2]);
    $current_user =  $modules_name[0];
  }else {
    $modules_name = explode('_v_', $modules_find[3]);
    $current_user =  $modules_name[0];
  }

}else{
  $modules_find = explode('/', $modules_find);
  $current_user = array_pop($modules_find);
//  $current_user = "";
