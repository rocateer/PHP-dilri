      ...
      <div style="max-width:600px; height:auto; margin: 0 auto; padding: 44px 20px 60px 20px; box-sizing: border-box;background-color: #F9F9F9;">
        ...
        <div style="background:#fff; border-radius: 10px; padding:40px; box-sizing:border-box;">
          ...
          <div style="text-align:center;margin: 0 auto; max-width:260px; margin-top:60px;">
            <a href="http://sususoft.pw.rocateerdev.co.kr/find_pw_to_email/member_pw_change_key_check?p_code=<?=$data['change_pw_key']?>&current_lang=<?=$data['current_lang']?>" style="padding: 13px 0; text-decoration: none; display: block; background:#009648;border-radius:2px; color:#fff; text-align:center;"><?=lang("lang_find_pw_00005","링크로 이동")?></a>
          </div>
        </div>
      </div>
