  ...
  <div class="body">
    ...
    <div class="table-responsive">
      ...
      <div class="row table_title">
        ...
        <div class="col-lg-6 text-left" style="margin-bottom:10px">
          <input name="member_id" id="member_id" readonly style="width:65%">
      ...
      <div class="" id="temp_list_ajax">
        ...
        <div class="text-right" style="float:right;margin-top:20px">
          ...
          <a class="btn btn-gray" href="javascript:void(0)" onclick="alert('파일을 선택해주세요');">데이터 업로드</a>
        </div>
