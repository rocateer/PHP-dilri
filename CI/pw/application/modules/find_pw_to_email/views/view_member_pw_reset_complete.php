...
<body class="pw_bg">
    <div class="centered">
      ...
      <div style="text-align:center; padding-top:50px;">
          ...
          <span style="font-size:20px; font-weight:bold;"> <?=$this->global_function->get_translation('lang_member_pw_change_00708', $current_lang, "비밀번호 변경이 완료되었습니다.")?></span><br>
          <p style="font-size:12px; color:#666; padding-top:20px;"><?=$this->global_function->get_translation('lang_member_pw_change_00019', $current_lang, "변경된 비밀번호를 이용하여 서비스를 이용해 주세요.")?></p>
