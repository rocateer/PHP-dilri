    ...
    <div class="centered">
      ...
      <div class="w_box">
        <div class="pw_con">
          ...
          <h1 class="pw_h1"> <?=$this->global_function->get_translation('lang_member_pw_change_00698', $data['current_lang'], "비밀번호 변경")?></h1>
          <ul class="pw_area">
            <li>
              <label><?=$this->global_function->get_translation('lang_member_pw_change_00701', $data['current_lang'], "새 비밀번호")?></label>
              <input type="password" name="member_pw" id="member_pw" placeholder="<?=$this->global_function->get_translation('lang_member_pw_change_00701', $data['current_lang'], "비밀번호")?>">
            </li>
            <li>
              <label><?=$this->global_function->get_translation('lang_member_pw_change_00703', $data['current_lang'], "비밀번호 확인")?></label>
              <input type="password" name="member_pw_check" id="member_pw_check" placeholder="<?=$this->global_function->get_translation('lang_member_pw_change_00703', $data['current_lang'], "비밀번호확인")?>">
            </li>
              <li class="txt-right">
              <a href="javascript:void(0);" class="btn" onclick="javascript:saveFn();"><?=$this->global_function->get_translation('lang_join_00074', $data['current_lang'], "확인")?></a>
            </li>
          </ul>
        </div>
      </div>
